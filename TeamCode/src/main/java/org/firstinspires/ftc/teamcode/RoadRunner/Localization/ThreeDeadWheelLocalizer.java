...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 8917.390727968648; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -8788.632322751928; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 3133.908601863321; // x position of the perpendicular encoder (in tick units)
    }
