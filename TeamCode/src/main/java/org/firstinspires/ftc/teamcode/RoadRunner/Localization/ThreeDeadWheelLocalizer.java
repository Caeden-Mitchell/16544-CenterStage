...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 8928.819109861599; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -8987.32802877348; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 3059.0353288588435; // x position of the perpendicular encoder (in tick units)
    }
